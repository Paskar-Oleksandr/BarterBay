...
public class ComplimentBot extends TelegramLongPollingBot {
  ...
  public void onUpdateReceived(Update update) {
    ...
    if (START_COMMAND.equals(botCommand)) {
      sendMessage = createStartWelcomeMessage(update);
    } else {
  ...
  private SendMessage createStartWelcomeMessage(Update update) {
    final var userFirstName = update.getMessage().getFrom().getFirstName();
  ...
  private SendMessage createSendMessageForTelegram(Update update, String messageText) {
